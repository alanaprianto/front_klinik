...
<head>
    ...
    <link href="{{asset('views/kiosk/style.css')}}" rel="stylesheet">
...
<body class="white-bg"
     style="padding: 15px;
            ...
            text-align: center;
            position: absolute;
            background-image: url('{{url('/assets/images/background/shattered.png')}}')">
<div class="text-center">
    ...
    <div class="panel-body">
        ...
        <a class="btn  btn-print" type="button" href="javascript:;" data-type="contractor">
            <img src="assets/images/button/icon-contractor.png" style="height: 200px">
        </a>
    </div>
    <h1></h1>
