...
@section('content')
    ...
    <div id="pendaftaranPasien-area" ng-controller="MasterUserCtrl" >
        <div class="row no-margin">
            <div class="col-md-12 no-padding m-b-15">
                <button 
                    class="btn btn-info col-md-4 no-radius" 
                    ng-click="openModal('credStaffJobModal', 'tambah')"> Tambah User</button>
            </div>
            <div class="col-md-12 no-padding">
                <table id="example" class="ui teal celled table compact display nowrap" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        <tr ng-repeat="u in tablelistUser">
                            <td>[[$index + 1]]</td>
                            <td>[[u.username]]</td>
                            <td>[[u.email]]</td>
                            <td>
